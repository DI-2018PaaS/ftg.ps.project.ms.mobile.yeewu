...
//import { InscriptionOKPage } from '../../common/inscription-ok/inscription-ok';

@Component({
  selector: 'page-inscription-ok',
  templateUrl: 'inscription-ok.html'
})
export class InscriptionOKPage {
